...
const eachElementInFirstIsEven = firstArray.every(numer => numer % 2 === 0);
const eachElementInFirstIsOdd = firstArray.every(num => num % 2 !== 0);

const eachElementInSecondIsEven = secondArray.every(numer => numer % 2 === 0);
const eachElementInSecondIsOdd = secondArray.every(num => num % 2 !== 0);

const eachElementInThirdIsEven = thirdArray.every(numer => numer % 2 === 0);
